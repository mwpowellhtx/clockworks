...
namespace Kingdom.Clockworks
{
            ...
            , ISteppableClock
    {
        ...
        {
            const double defaultInterval = default(double);

            // Either cause to be Infinity (stopped) or allow positive only.
            interval = (double.IsInfinity(interval) || interval <= defaultInterval)
