...
namespace Kingdom.Unitworks.Units
{
    ...
    /// of the Mass components really do not matter that much.
    /// </summary>
    public class MassConverterTests : MassUnitTestFixtureBase
    {
        /// <summary>
        /// Runs a <see cref="MassConverter"/> <paramref name="scenario"/>.
        /// </summary>
        /// <param name="scenario"></param>
        private static void RunConverterScenario(Action<MassConverter> scenario)
        {
        ...
        {
            var units = GetEnumValues<MassUnit>().ToArray();
        ...
        /// <returns></returns>
        private double GetExpectedConvertResult(double value, MassUnit fromUnit, MassUnit toUnit, MassUnit baseUnit)
        {
        ...
        [Test]
        [Combinatorial]
        public void Converter_converts_value_correctly([MassUnitValues] MassUnit fromUnit,
            [MassQuantityValues] double fromValue, [MassUnitValues] MassUnit toUnit)
        {
            RunConverterScenario(converter =>
            {
